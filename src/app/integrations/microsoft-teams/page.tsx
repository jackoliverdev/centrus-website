...
const steps = [
  ...
  },
  {
    ...
    description: 'Click the "Connect to Microsoft Teams" button and approve access permissions.',
  },
  {
    title: 'Select Channels',
    description: 'Choose which Teams channels and chats you want Centrus to learn from.',
  },
  {
    title: 'Sync and Train',
    description: 'Press sync to import your selected conversations into the Documents tab.',
  },
  {
    title: 'Organise and Chat',
    description: 'Tag your content and start chatting with your Teams knowledge immediately.',
  },
];
