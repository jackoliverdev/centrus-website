...
const steps = [
  {
    ...
    description: 'Navigate to Edit User and ensure your phone number includes the country code (e.g., +44 for UK).',
  },
  {
    title: 'Save Centrus Contact',
    description: 'Find the Centrus WhatsApp number on the integrations page and save it as a contact.',
  },
  {
    title: 'Start Chat',
    description: 'Open WhatsApp and message Centrus. The system will match your phone number to your account.',
  },
  {
    title: 'Select Tag',
    description: 'Choose which knowledge tag you want to chat about when prompted.',
  },
  {
    title: 'Chat Freely',
    description: 'Send messages to query your knowledge base. Type "RESTART CHAT" to switch tags or start a new thread.',
  },
];
